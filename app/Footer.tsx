...
export default function Footer() {
    return (
        <footer className="p-4 relative align-baseline w-full inset-x-0 bottom-0 rounded-t-lg shadow md:flex md:items-center md:justify-between md:py-6 md:px-48 bg-gray-200 dark:bg-gray-800">
